...
$(document).ready(function(){
    ...
    let topics=["meercat","unicorn","cheetah","liger","fox","wolf","jellyfish","sloth","grizzly","eagle","mammoth"];
    ...
    // Function that creates buttons using array elements
   ...
   // Add a click event listener on the images to make ajax call from the API
